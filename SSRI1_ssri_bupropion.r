...
drug_treatment <- "ssri"
drug_control <- "bupropion"
outcome <- "sui"
  
source("clean_data_ssri_bupropion.R")
data <- clean_data_ssri_bupropion(data,dataset_drug_df,dataset_condition_df,dataset_survey_df,drug_treatment,drug_control,seed=1
...
write.csv(data, "data_ssri_bupropion.csv")
system(paste("gsutil cp", "data_ssri_bupropion.csv", paste0(bucket,"/data/","data_ssri_bupropion.csv")))
