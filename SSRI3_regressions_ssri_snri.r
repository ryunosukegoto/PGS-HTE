...
libs <- c("ggfortify","survival","grf","MatchIt","tableone","geepack","Information","missForest","doParallel","foreach","randomForest","itertools","doRNG","arsenal","fastDummies","parallel","stringr","purrr","naniar","dplyr","forestploter")
requireLibs(libs)
rm(requireLibs,libs)


bucket <- Sys.getenv("WORKSPACE_BUCKET")
file_path <- paste0(bucket,"/data/sample_ssri_snri_scored.csv")
system(paste("gsutil cp", file_path, "sample_ssri_snri_scored.csv"))
sample <- read.csv("sample_ssri_snri_scored.csv")
...
forest.res$Subgroup <- c("All patients",
                         ...
                         "   No",
                         "   Yes",
                         "Previous diagnosis of suicidal thoughts",
                         "   No",
                         "   Yes",
                         "Previous diagnosis of GAD",
                         "   No",
                         "   Yes",
                         "Previous diagnosis of alcohol abuse",
                         "   No",
                         "   Yes",
                         "Previous diagnosis of substance abuse",
                         "   No",
                         "   Yes",
                         "Previous diagnosis of schizophrenia",
                         "   No",
                         "   Yes",
                         "Previous diagnosis of eating disorders",
                         "   No",
                         "   Yes",
                         ...
                         "   Low",
                         "   High",
                         "PGS self-injurious behavior",
                         "   Low",
                         "   High",
                         "PGS anxiety",
                         "   Low",
                         "   High",
                         "PGS bipolar disorder",
                         "   Low",
                         "   High",
                         "PGS schizophrenia",
                         "   Low",
...
forest.res$est <- c(summary(cox)$conf.int[1],
                    ...
                    NA,
                    summary(cox.sui_pmh0)$conf.int[1],
                    summary(cox.sui_pmh1)$conf.int[1],
                    NA,
                    summary(cox.anxiety_pmh0)$conf.int[1],
                    summary(cox.anxiety_pmh1)$conf.int[1],
                    NA,
                    summary(cox.alcohol_pmh0)$conf.int[1],
                    summary(cox.alcohol_pmh1)$conf.int[1],
                    NA,
                    summary(cox.substance_pmh0)$conf.int[1],
                    summary(cox.substance_pmh1)$conf.int[1],
                    NA,
                    summary(cox.schizophrenia_pmh0)$conf.int[1],
                    summary(cox.schizophrenia_pmh1)$conf.int[1],
                    NA,
                    summary(cox.eating_pmh0)$conf.int[1],
                    summary(cox.eating_pmh1)$conf.int[1],
                    NA,
                    summary(cox.ptsd_pmh0)$conf.int[1],
                    summary(cox.ptsd_pmh1)$conf.int[1],
                    NA,
                    summary(cox.adhd_pmh0)$conf.int[1],
                    summary(cox.adhd_pmh1)$conf.int[1],
                    NA,
                    summary(cox.tca_pre0)$conf.int[1],
                    summary(cox.tca_pre1)$conf.int[1],
                    NA,
...
forest.res$lcl <- c(summary(cox)$conf.int[c(3)],
                    ...
                    NA,
                    summary(cox.sui_pmh0)$conf.int[c(3)],
                    summary(cox.sui_pmh1)$conf.int[c(3)],
                    NA,
                    summary(cox.anxiety_pmh0)$conf.int[c(3)],
                    summary(cox.anxiety_pmh1)$conf.int[c(3)],
                    NA,
                    summary(cox.alcohol_pmh0)$conf.int[c(3)],
                    summary(cox.alcohol_pmh1)$conf.int[c(3)],
                    NA,
                    summary(cox.substance_pmh0)$conf.int[c(3)],
                    summary(cox.substance_pmh1)$conf.int[c(3)],
                    NA,
                    summary(cox.schizophrenia_pmh0)$conf.int[c(3)],
                    summary(cox.schizophrenia_pmh1)$conf.int[c(3)],
                    NA,
                    summary(cox.eating_pmh0)$conf.int[c(3)],
                    summary(cox.eating_pmh1)$conf.int[c(3)],
                    NA,
                    summary(cox.ptsd_pmh0)$conf.int[c(3)],
                    summary(cox.ptsd_pmh1)$conf.int[c(3)],
                    NA,
                    summary(cox.adhd_pmh0)$conf.int[c(3)],
                    summary(cox.adhd_pmh1)$conf.int[c(3)],
                    NA,
                    summary(cox.tca_pre0)$conf.int[c(3)],
                    summary(cox.tca_pre1)$conf.int[c(3)],
                    NA,
...
forest.res$ucl <- c(summary(cox)$conf.int[c(4)],
                    ...
                    NA,
                    summary(cox.sui_pmh0)$conf.int[c(4)],
                    summary(cox.sui_pmh1)$conf.int[c(4)],
                    NA,
                    summary(cox.anxiety_pmh0)$conf.int[c(4)],
                    summary(cox.anxiety_pmh1)$conf.int[c(4)],
                    NA,
                    summary(cox.alcohol_pmh0)$conf.int[c(4)],
                    summary(cox.alcohol_pmh1)$conf.int[c(4)],
                    NA,
                    summary(cox.substance_pmh0)$conf.int[c(4)],
                    summary(cox.substance_pmh1)$conf.int[c(4)],
                    NA,
                    summary(cox.schizophrenia_pmh0)$conf.int[c(4)],
                    summary(cox.schizophrenia_pmh1)$conf.int[c(4)],
                    NA,
                    summary(cox.eating_pmh0)$conf.int[c(4)],
                    summary(cox.eating_pmh1)$conf.int[c(4)],
                    NA,
                    summary(cox.ptsd_pmh0)$conf.int[c(4)],
                    summary(cox.ptsd_pmh1)$conf.int[c(4)],
                    NA,
                    summary(cox.adhd_pmh0)$conf.int[c(4)],
                    summary(cox.adhd_pmh1)$conf.int[c(4)],
                    NA,
                    summary(cox.tca_pre0)$conf.int[c(4)],
                    summary(cox.tca_pre1)$conf.int[c(4)],
                    NA,
...
forest.res$'P-for-\ninteraction' <- c('',
                                      ...
                                      round2(P.smoker,2),'','',
                                      round2(P.sui_pmh,2),'','',
                                      round2(P.anxiety_pmh,2),'','',
                                      round2(P.alcohol_pmh,2),'','',
                                      round2(P.substance_pmh,2),'','',
                                      round2(P.schizophrenia_pmh,2),'','',
                                      round2(P.eating_pmh,2),'','',
                                      round2(P.ptsd_pmh,2),'','',
                                      round2(P.adhd_pmh,2),'','',
                                      round2(P.tca_pre,2),'','',
...
p <- forest(forest.res[,c(1,5,6)],
            ...
            ci_column = 2,
            ref_line = 1,
            arrow_lab = c("SSRI Better","SNRI Better"),
            xlim = c(0, 2.5),
